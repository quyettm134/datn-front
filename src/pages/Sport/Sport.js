...
import './Sport.css';
import SportSlide from "../../assets/images/sport.jpg";
export default function Sport() {
    ...
    const menProductList = productList?.filter(product => product.index_group_name === 'Sport');

    return (
        <div className="vw-100">
            <Header />

            <Container fluid className="sport-content vw-auto" style={{marginTop: '30px'}}>
                <Row className="d-flex justify-content-center align-items-stretch" style={{paddingBottom: '30px', marginTop: '50px'}}>
                    <Image src={SportSlide} style={{zIndex: '0', height: '500px'}}/>
                    <div className="d-flex justify-content-center align-items-center h-100" style={{zIndex: '1', marginTop: '-270px'}}>
                        <p className="text-white fs-1 fw-bolder">SPORT ACCESSORIES</p>
                    </div>
                </Row>
