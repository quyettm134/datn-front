...
import './Divided.css';
import DividedSlide from "../../assets/images/divided.png";
export default function Divided() {
    ...
    const menProductList = productList?.filter(product => product.index_group_name === 'Divided');

    return (
        <div className="vw-100">
            <Header />

            <Container fluid className="divided-content vw-auto" style={{marginTop: '30px'}}>
                <Row className="d-flex justify-content-center align-items-stretch" style={{paddingBottom: '30px', marginTop: '50px'}}>
                    <Image src={DividedSlide} style={{zIndex: '0', height: '500px'}}/>
